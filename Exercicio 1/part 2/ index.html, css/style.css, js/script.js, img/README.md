Markdown
# Estrutura de Projeto Web — Exercício 1 (Parte 2)
...
* **`img/`**: Pasta reservada para guardar todos os recursos visuais locais do projeto, como imagens, ícones, logotipos ou backgrounds.
...
* **`js/script.js`**: Arquivo responsável por programar as interações dinâmicas da página (funções em JavaScript), respondendo aos cliques do usuário, validações ou animações.
* **`README.md`**: Arquivo de documentação do repositório escrito em Markdown. Serve para guiar outros desenvolvedores (ou avaliadores) explicando o que é o projeto, como ele funciona e qual a função de cada elemento.
